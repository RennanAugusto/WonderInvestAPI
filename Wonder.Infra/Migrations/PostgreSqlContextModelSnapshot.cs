...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wonder.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Wonder.Domain.Models.RlcWalletTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Wonder.Domain.Models.StockFavorites", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("IdWonderUsers")
                        .HasColumnType("text");
                    ...
                    b.ToTable("StockFavorites");
                });

            modelBuilder.Entity("Wonder.Domain.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Wonder.Domain.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wonder.Domain.Models.StockFavorites", b =>
                {
                    b.HasOne("Wonder.Domain.Models.Stock", "Stock")
                        .WithMany()
                        .HasForeignKey("StockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
